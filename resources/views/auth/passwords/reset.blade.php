            ...
            <div class="p-5 sm:p-6 md:p-8">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" value="{{ $email ?? old('email') }}" required class="form-input rounded-lg">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary w-full py-3 rounded-xl font-semibold text-base mt-2">Reset Password</button>
                </form>
