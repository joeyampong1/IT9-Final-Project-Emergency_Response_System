...
@section('content')
    @include('layouts.page-header', ['title' => 'Create New User'])
        ...
        <div class="p-6 md:p-8">
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="flex justify-end mt-8">
                    <button type="submit" class="btn btn-primary px-8 py-2.5 rounded-lg shadow-md hover:shadow-lg transition">Create User</button>
                </div>
            </form>
        </div>
    </div>
